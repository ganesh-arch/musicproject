...
playsound('C:\\Users\\Ganesh Reddy\\Desktop\\blogs\\sample.mp3')
import os
os.startfile('C:\\Users\\Ganesh Reddy\\Desktop\\blogs\\sample.mp3')'''
import pygame
...
root=Tk()
root.title('ProjectGaneshReddy Music player project')
...
os.chdir(r'C:\Users\Ganesh Reddy\Desktop\janaganamana')
songs=os.listdir()
for s in songs:
